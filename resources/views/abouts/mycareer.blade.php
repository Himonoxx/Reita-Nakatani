    ...
    <div class="card col-sm-7">
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item"><b>メッセージ</b><br>皆さんここまで見て頂きありがとうございます。<br>
                                                    ...
                                                    つたないサイトではありますが少しでも自分の事を知って頂けたら幸いです。<br><br>
                                                    ***************Special Thanks*************************************************************<br>
                                                    サイト制作にあたり使用した素材はロイヤリティフリーのものを使用しております。<br>
                                                    Matt-Hoffmanさん　https://unsplash.com/@__matthoffman__<br>
                                                    Oleg-Magniさん   https://www.pexels.com/@oleg-magni<br>
                                                    ******************************************************************************************<br>
                                                    ご協力頂き、有難う御座いました。<br>
                                                    </li>
      </ul>
...
<div class="card col-sm-12">
    ...
    <table class="table">
        ...
        <tr class="table-light">
            <td>2011年4月</td>
            <td>日本大学 工学部 電気電子工学科</td>
        </tr>
        <tr class="table-light">
            <td>2015年4月～2019年6月</td>
            <td>古河電池株式会社</td>
        </tr>
    </table>    
</div>
